...
export default function Contact() {
  return (
    <div className="mt-20 bg-second rounded-lg">
      <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif] max-w-6xl max-lg:max-w-3xl mx-auto">
          ...
          <ul className="mt-12 space-y-8">
            <li className="flex items-center">
              ...
              <a
                ...
                className="text-gray-900 text-sm ml-4"
              >
                info@example.com
              </a>
            </li>
        ...
        <div className="bg-gray-100 p-6 rounded-lg">
          ...
          <div className="space-y-4 max-lg:mt-4">
            <button
              type="button"
              className="px-4 py-2 rounded-lg bg-main text-gray-900 text-sm tracking-wider font-medium outline-none border-2 border-main mr-4"
            >
              Web design
            </button>
            <button
