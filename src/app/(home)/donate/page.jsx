        ...
        <div className="bg-white md:col-span-3 p-4 sm:p-6 md:p-12">
          ...
          <div className="space-y-4 mt-4">
            ...
            <p className="text-gray-700">
              ...
              sequi repudiandae doloremque? Incidunt nostrum ad, ex aut sint
              eaque nesciunt amet ducimus facere quia laudantium placeat
              temporibus assumenda recusandae nobis consequatur vel voluptatum
              officiis! Amet repellat dolorem autem, sit, perferendis deleniti
              neque aliquid consequatur nobis quis eum eius debitis aperiam
              reprehenderit minus est nulla ullam culpa! Error laboriosam aut
              repudiandae, earum, at minus alias voluptatum reiciendis, amet
              quia voluptatibus nemo nostrum facere similique libero atque
              cupiditate blanditiis rerum dolorem rem ea? Soluta corporis,
              ratione aliquam perferendis autem, veniam neque aliquid
              voluptatibus distinctio deserunt sit.
            </p>
