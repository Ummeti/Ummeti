...
export default function Sidebar() {
  return (
    <aside>
      <div className="flex md:hidden flex-col items-center w-16 h-full overflow-hidden text-gray-700 bg-gray-100 rounded">
      ...
      <div className="hidden md:flex flex-col items-center w-40 h-full overflow-hidden text-gray-700 bg-gray-100 rounded">
