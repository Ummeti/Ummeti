  ...
  return (
    ...
    >
      <g
        ...
        strokeWidth={1.5}
      >
        <path d="M13.848 13.317L9.505 18.28a2 2 0 0 1-3.01 0l-4.343-4.963a2 2 0 0 1 0-2.634L6.495 5.72a2 2 0 0 1 3.01 0l4.343 4.963a2 2 0 0 1 0 2.634"></path>
        <path d="m13 19l4.884-5.698a2 2 0 0 0 0-2.604L13 5"></path>
        <path d="m17 19l4.884-5.698a2 2 0 0 0 0-2.604L17 5"></path>
      </g>
    </svg>
  );
}
